...
namespace AuraUWP.Extensions
{
    public static class IEnumerableExtensions
    {
        ...
        public static List<SemanticZoomGroup<TSource>> ToGroups<TSource, TSort, TGroup>(
        ...
        {
            var groups = new List<SemanticZoomGroup<TSource>>();
            ...
            {
                SemanticZoomGroup<TSource> group = new SemanticZoomGroup<TSource>();
        ...
        /// <returns>A list of JumpListGroups.</returns>
        public static List<SemanticZoomGroup<TSource>> ToAlphaGroups<TSource>(
            this IEnumerable<TSource> source, Func<TSource, string> selector)
        {
            ...
            var groupDictionary = keys.Select(x => new SemanticZoomGroup<TSource>() { Key = x.Value })
