        ...
        public void Continue(IContinuationActivatedEventArgs args, Frame rootFrame)
        {
            ...
            switch(args.Kind)
            {
                case ActivationKind.PickFileContinuation:
                    if (rootFrame.Content is IFileOpenPickerContinuable fileOpenPickerPage)
                    {
                ...
                case ActivationKind.PickSaveFileContinuation:
                    if (rootFrame.Content is IFileSavePickerContinuable fileSavePickerPage)
                    {
                ...
                case ActivationKind.PickFolderContinuation:
                    if (rootFrame.Content is IFolderPickerContinuable folderPickerPage)
                    {
                ...
                case ActivationKind.WebAuthenticationBrokerContinuation:
                    if (rootFrame.Content is IWebAuthenticationContinuable wabPage)
                    {
